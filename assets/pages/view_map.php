...
<nav aria-label="Page navigation">
    <ul class="pagination">
        <li>
            <a href="<?php echo "?view=map&name=" . esc($mapname) . "&p=1"; ?>" aria-label="Previous">
        ...
        $x = 1;
        while($x <= $row_cnt) {
            echo "<li><a href=\"?view=map&name=" . esc($mapname) . "&p=$x\">$x</a></li>";
            $x++;
        }
        ?>
        <li>
            <a href="<?php echo "?view=map&name=" . esc($mapname) . "&p=" . esc($row_cnt); ?>" aria-label="Next">
